...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        """
        new_dep_trans = Transaction(self.next_id,self.balance,(self.balance+amount))
        self.next_id +=1
        self.transactions.append(new_dep_trans)
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            new_dep_trans = Transaction(self.next_id,self.balance,self.balance)
            self.next_id += 1
            self.transactions.append(new_dep_trans)
...
class Coin:
    ...
    def worth(self):
        extra = max(0, Mint.present_year - self.year - 50)
